...
3)   un constructeur par copie  se declare comme suit ,  nomClasse(objetMemeclasse) 
et un constructeur par copie , objet1 =objet2   , les 2 objets sont de meme classe;
